...
export default function Cover() {
  return (
    <>
      <section
        className={`flex justify-center font-semibold bg-no-repeat bg-cover bg-[url('/bg-cover.svg')] relative -top-[100px] text-white min-h-[600px] max-h-[700px]`}
      >
        <div className='flex text-center relative top-[50px] flex-col justify-center items-center h-[700px] space-y-6 lg:w-1/3 md:w-1/2 w-4/5'>
